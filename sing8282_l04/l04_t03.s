...
LDR R6,[R2] // initialze minimum variable 
LDR R7,[R2,#4] // initailze maximum variable-pre increment without writeback
...
Loop:
	...
	// From Task 3
	CMP R0,R6 // compare with min
	MOVLT R6,R0
	
	CMP R0,R7 // compare with max
	MOVGT R7,R0
	
	CMP    R3, R2 // Looping Condition
	BNE    Loop  
_stop:
b _stop
...
.align
Data:
.word   -40,5,-9,100,3,0,8,-7,12    // The list of data
