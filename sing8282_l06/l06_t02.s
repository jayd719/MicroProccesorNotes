...
ldr    r3, =Max
stmfd  sp!, {r3}     // Push the address of location to store max

ldr    r3, =Min
stmfd  sp!, {r3}     // Push the address of location to store min

ldr    r3, =_Data
stmfd  sp!, {r3}     // Push the end of list to stack

ldr    r3, =Data
stmfd  sp!, {r3}     // Push the Start of list to stack
...
// allocate local storage (none) NO local variable used
